// responseTemplates.ts - Response templates for SJC Maasin CTE Chatbot

export const GREETING_RESPONSE = `Hello! 👋 Welcome to SJC Maasin CTE
...
export const HOW_ARE_YOU_RESPONSE = `Hi there! 😊 I'm doing great and ready to help you learn about SJC Maasin CTE.
...
✓ Strong alumni network in the education sector

Which program would you like to know more about?`;

export const ENROLLMENT_RESPONSE = `📋 Admission Requirements & Process
...
Next Steps
Ready to apply? I can provide more details about the process or connect you with our admissions office.`;

export const PRACTICUM_RESPONSE = `👩‍🏫 Student Teaching Program
...
export const EXAM_RESPONSE = `📊 Licensure Exam for Teachers (LET)
...
Ready to succeed in your teaching career? Let me know if you’d like more details about our LET preparation programs.`;

export const EVENT_RESPONSE = `🎉 Campus Life & Activities
...
export const FACILITY_RESPONSE = `🏫 Campus Facilities & Resources
...
export const SCHEDULE_RESPONSE = `📅 Academic Calendar & Class Schedule
...
We offer schedule options to accommodate working students and different learning preferences.

Would you like details about a specific schedule or deadline?`;

export const ABOUT_RESPONSE = `🏛️ About Saint Joseph College Maasin
...
export const STUDENT_LIFE_RESPONSE = `🎯 Student Life & Personal Development
...
export const ACHIEVEMENT_RESPONSE = `🏆 Achievements & Recognition
...
export const ADVANTAGE_RESPONSE = `⭐ Why Choose SJC Maasin CTE?
...
export const INQUIRY_RESPONSE = `💭 I'm Here to Help!
...
Quick Questions?
Just ask me anything about SJC Maasin CTE, and I’ll provide the information you need!
...
export const BEED_RESPONSE = `🎓 Bachelor of Elementary Education (BEEd)
...
export const BSED_RESPONSE = `🎓 Bachelor of Secondary Education (BSEd)
...
🏫 Extensive fieldwork and practice teaching
...
export const THANKS_RESPONSE = `🙏 You’re very welcome!
...
But no worries — I can still help you! 🎓  

Welcome to SJC Maasin CTE, one of the Philippines’ oldest Catholic colleges (since 1928).  
